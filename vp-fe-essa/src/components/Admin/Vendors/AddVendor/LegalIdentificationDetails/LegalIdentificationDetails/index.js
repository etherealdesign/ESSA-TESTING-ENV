...
const LegalIdentificationDetailsComp = ({ isEditable }) => {
  const {
    register,
    formState: { errors }
  } = useForm()
  ...
  return (
    <div>
      <div className={styles.liDetailsContainer}>
        ...
        <div>
          <Fieldset legend="Trade Licence" className={`${styles.fieldset} mb-5 mt-3`}>
            <div className={styles.row}>
              ...
              <div className={styles.uploadDocuments}>
                <label className='d-flex gap-1'>Uploaded Documents
        ...
        <div className={isEditable ? 'd-flex justify-content-between' : 'd-none'}>
          <NormalButton label={t('cancel')} outlineBtn customClass={styles.submitBtn} />
...
export default LegalIdentificationDetailsComp
